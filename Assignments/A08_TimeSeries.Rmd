...
#Trend for individual months
GaringerOzone.monthly_data_trend2 <- trend::smk.test(GaringerOzone.monthly.ts)
# Inspect results
GaringerOzone.monthly_data_trend2
summary(GaringerOzone.monthly_data_trend2)

```

> Answer: The seasonal Mann-Kendall is most appropriate because there is seasonality in the data and the data is non-parametric. Initial p value is slightly significant
