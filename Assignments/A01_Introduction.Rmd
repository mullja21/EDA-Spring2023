...
## Directions
1.  Rename this file `<JordanMullens>_A01_Introduction.Rmd` (replacing `<JordanMullens>` with your first and last name).
...
> Answer: No formal training. During the summer of 2022, I completed a statistics course on Coursera which had an Rstudio component. I taught myself a little bit of coding for that course and data visualization, but I would classify myself as a novice.

2. Are there any components of the course about which you feel confident?

> Answer: I feel comfortable working with RStudio, but not 100% confident in my coding abilities.

3. Are there any components of the course about which you feel apprehensive?

> Answer: Not really- I am very open to learning and excited to have in-person instruction.
...
> Answer: https://github.com/mullja21/EDA-Spring2023
